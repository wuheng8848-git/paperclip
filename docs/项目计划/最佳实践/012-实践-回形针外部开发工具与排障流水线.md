...
**与邻近文书分工：** 个案证据链、长表归因仍在 **[`../探查/`](../探查/README.md)**；可复用的 **API 顺序 / SQL 模板 / 命令** 在 **[002](002-实践-事务运行记录API取证路径.md)**、**[004](004-实践-事务心跳与僵尸run排障.md)**、**[010](010-实践-从Postgres核查公司与智能体.md)**；本文只钉 **「谁先谁后、脚本往哪登记、助手默认该怎么做」**。

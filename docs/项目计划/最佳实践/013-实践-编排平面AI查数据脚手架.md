...
| **`issues`** | 工单真源：**状态、assignee、`checkout_run_id` / `execution_run_id`、执行策略 JSON**；拼「卡在谁 / 哪次 run」 |
...
| 入口 | 何时用 |
| --- | --- |
| **[020](./020-实践-排障指南.md)** | **排障 / 取证总入口**：`pnpm issue:forensics`、`activity:company`、002/004/012/018… |
| **[**010**](./010-实践-从Postgres核查公司与智能体.md)** | 公司已对齐、要 SQL **模版与运维习惯** |

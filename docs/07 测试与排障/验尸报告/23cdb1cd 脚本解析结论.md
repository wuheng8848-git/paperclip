...
**通则：** [`../最佳实践/022`](../../编排/提示词与上下文 prompt-and-context.md) · 对照 [`2c4a30b3 脚本解析结论`](2c4a30b3%20脚本解析结论.md)（ROU-3 · 乱码 + retry）
...
上级：[验尸报告目录](.) · [022 §9 cursor 暂缓](../../编排/提示词与上下文 prompt-and-context.md#9-cursor-local-无头暂缓另开修复)

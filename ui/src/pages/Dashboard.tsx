...
import { nav, dashboard } from "../lib/i18n";
...
export function Dashboard() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: nav.dashboard }]);
  }, [setBreadcrumbs]);
    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message={dashboard.welcomeNoCompany}
          action={dashboard.getStarted}
          onAction={openOnboarding}
        />
      );
    }
    return (
      <EmptyState icon={LayoutDashboard} message={dashboard.selectCompany} />
    );
  }
        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {dashboard.budgetIncidents(data.budgets.activeIncidents)}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {dashboard.budgetDetail(
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {dashboard.runningPausedErrors(data.agents.running, data.agents.paused, data.agents.error)}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {dashboard.openBlocked(data.tasks.open, data.tasks.blocked)}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? dashboard.pctOfBudget(
                        String(data.costs.monthUtilizationPercent),
                        formatCents(data.costs.monthBudgetCents),
                      )
                    : dashboard.unlimitedBudget}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? dashboard.budgetOverridesPending(data.budgets.pendingApprovals)
            ...
            <div className="min-w-0">
              ...
              {recentIssues.length === 0 ? (
                <div className="border border-border p-4">
                  <p className="text-sm text-muted-foreground">{dashboard.noTasksYet}</p>
                </div>
              ) : (
                <div className="border border-border divide-y divide-border overflow-hidden">

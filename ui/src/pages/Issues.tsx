...
import { issueBreadcrumb, issuesPage } from "../lib/i18n";
...
export function Issues() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: issuesPage.title }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={CircleDot} message={issuesPage.emptySelectCompany} />;
  }
